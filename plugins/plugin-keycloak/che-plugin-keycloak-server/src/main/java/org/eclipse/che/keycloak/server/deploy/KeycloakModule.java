...
import org.eclipse.che.keycloak.server.WsMasterKeycloakConfigResolver;
...
public class KeycloakModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(KeycloakConfiguration.class).asEagerSingleton();
    bind(KeycloakConfigResolver.class).to(WsMasterKeycloakConfigResolver.class);
