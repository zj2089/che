...
public class ProjectServiceClientImplTest {
  ...
  public void shouldEncodeUrlAndEstimateProject() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/estimate/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20?type=java";
  ...
  public void shouldEncodeUrlAndResolveProjectSources() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/resolve/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20";
    verify(requestFactory).createGetRequest(eq(expectedUrl));
    verify(asyncRequest).header(ACCEPT, MimeType.APPLICATION_JSON);
  ...
  public void shouldEncodeUrlAndImportProject() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/import/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20";
  ...
  public void shouldEncodeUrlAndSearchResourceReferences() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/search/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20"
  ...
  public void shouldCreateOneProjectByBatch() {
    ...
    verify(requestFactory)
        .createPostRequest(eq("http://127.0.0.3/api/project/batch"), prjsArgCaptor.capture());
    verify(asyncRequest).header(ACCEPT, MimeType.APPLICATION_JSON);
  ...
  public void shouldEncodeUrlAndCreateFile() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/file/TestPrj?name=http%25253A%25252F%25252F.org%25252Fte%20st%20";
  ...
  public void shouldEncodeUrlAndGetFileContent() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/file/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20";
    verify(requestFactory).createGetRequest(eq(expectedUrl));
  ...
  public void shouldEncodeUrlAndCreateFolder() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/folder/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20";
    verify(requestFactory).createPostRequest(eq(expectedUrl), any());
  ...
  public void shouldEncodeUrlAndDeleteFolder() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20";
  ...
  public void shouldEncodeUrlAndCopyResource() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/copy/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20"
  ...
  public void shouldEncodeUrlAndMoveResource() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/move/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20"
            + "?to=TestPrj/target%20here*%20";
  ...
  public void shouldEncodeUrlAndGetTree() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/tree/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20"
  ...
  public void shouldEncodeUrlAndGetItem() {
    ...
    String expectedUrl =
        "http://127.0.0.3/api/project/item/TestPrj/http%25253A%25252F%25252F.org%25252Fte%20st%20";
    verify(requestFactory).createGetRequest(eq(expectedUrl));
    verify(asyncRequest).header(ACCEPT, MimeType.APPLICATION_JSON);
