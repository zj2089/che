...
/**
 * A ANSI output stream extracts ANSI escape codes written to an output stream and calls
 * corresponding <code>process*</code> methods.
 *
 ...
 * OutputStream: <code>process*</code> methods are empty. Subclasses should actually perform the
...
public class AnsiOutputStream extends FilterOutputStream {
  ...
  public synchronized void write(int data) throws IOException {
    switch (state) {
      ...
      case LOOKING_FOR_INT_ARG_END:
        ...
        if (!('0' <= data && data <= '9')) {
          String strValue =
              new String(buffer, startOfValue, (pos - 1) - startOfValue, StandardCharsets.UTF_8);
      ...
      case LOOKING_FOR_ST:
        ...
        if (SECOND_ST_CHAR == data) {
          String value =
              new String(buffer, startOfValue, (pos - 2) - startOfValue, StandardCharsets.UTF_8);
          options.add(value);
          reset(processOperatingSystemCommand(options));
        } else {
          state = LOOKING_FOR_OSC_PARAM;
  ...
  /**
   * Process <code>CSI u</code> ANSI code, corresponding to <code>RCP – Restore Cursor Position
   * </code>
   *
   * @throws IOException
   */
  ...
  @Deprecated protected static final int ATTRIBUTE_NEGATIVE_Off = 27; // 	Image; Positive
   ...
   * <code>40-49</code> (background), <code>90-97</code> (foreground high intensity) or <code>
   * 100-107</code> (background high intensity)
   *
   * @param attribute
   * @throws IOException
  ...
  /**
   * process <code>SGR 30-37</code> or <code>SGR 90-97</code> corresponding to <code>
   * Set text color (foreground)</code> either in normal mode or high intensity.
   *
   * @param color the text color
  ...
  /**
   * process <code>SGR 40-47</code> or <code>SGR 100-107</code> corresponding to <code>
   * Set background color</code> either in normal mode or high intensity.
   *
   * @param color the background color
   * @param bright is high intensity?
   * @throws IOException
  ...
  /**
   * process <code>SGR 48</code> corresponding to <code>extended set background color</code> with a
   * palette of 255 colors.
   *
  ...
  /**
   * process <code>SGR 48</code> corresponding to <code>extended set background color</code> with a
   * 24 bits RGB definition of the color.
   *
   * @param r red
   * @param g green
   * @param b blue
  ...
  /**
   * process <code>CSI n ; m H</code> corresponding to <code>CUP – Cursor Position</code> or <code>
   * CSI n ; m f</code> corresponding to <code>HVP – Horizontal and Vertical Position</code>
   *
   * @param row
   * @param col
   * @throws IOException
