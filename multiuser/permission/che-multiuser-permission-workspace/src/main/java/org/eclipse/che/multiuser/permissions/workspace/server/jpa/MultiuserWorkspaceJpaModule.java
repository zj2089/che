 ...
 */
package org.eclipse.che.multiuser.permissions.workspace.server.jpa;
...
import org.eclipse.che.multiuser.permissions.workspace.server.WorkspaceDomain;
import org.eclipse.che.multiuser.permissions.workspace.server.jpa.listener.RemoveStackOnLastUserRemovedEventSubscriber;
import org.eclipse.che.multiuser.permissions.workspace.server.model.impl.WorkerImpl;
import org.eclipse.che.multiuser.permissions.workspace.server.spi.WorkerDao;
import org.eclipse.che.multiuser.permissions.workspace.server.spi.jpa.JpaStackPermissionsDao;
import org.eclipse.che.multiuser.permissions.workspace.server.spi.jpa.JpaWorkerDao;
import org.eclipse.che.multiuser.permissions.workspace.server.stack.StackDomain;
import org.eclipse.che.multiuser.permissions.workspace.server.stack.StackPermissionsImpl;
